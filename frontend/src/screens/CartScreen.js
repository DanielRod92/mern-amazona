        ...
        <div>
            ...
            <Row>
                <Col md={8}>
                    {cartItems.length === 0 ? (
                        <MessageBox>
                            El carrito esta vacio. <Link to="/">Volver a la tienda</Link>
                        </MessageBox>
                    ) :
                        (
                            <ListGroup>
                            ...
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>
                                    <div className="d-grid">
                                        <Button type="button" onClick={checkoutHandler} variant="primary" disabled={cartItems.length === 0}>Proceder a pagar</Button>
                                    </div>
                                </ListGroup.Item>
                            </ListGroup>
                        </Card.Body>
